    ...
    <div class="w-full bg-neutral-900 text-white">
        <div x-data="{ open: false }" class="mx-auto flex max-w-screen-xl flex-col px-4 lg:flex-row lg:items-center lg:justify-between lg:px-6 lg:px-8">
                    ...
                    <div @click.away="open = false" class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 mt-2  origin-top-right rounded-md shadow-lg md:w-48">
                            <div class="rounded-md bg-black px-2 py-2 shadow">
                                <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-amber-500 focus:text-gray-900 focus:outline-none md:mt-0" href="route('profile.edit')">Settings</a>
                                <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-gray-200 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('user_watchlist') }}">Watchlist</a>
                                <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-gray-200 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="/user_lists">List</a>
                                <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-gray-200 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('dashboard', Auth::user()->id) }}">Dashboard</a>
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="hidden flex-grow flex-col pb-4 lg:flex lg:flex-row lg:justify-end lg:pb-0"> <!-- lg = @media (min-width: 1024px) -->
                @if(Auth::user())
                <form action="{{ route('movies.show')}}" method="GET">
                    <input hidden name="user_id" value="{{Auth::user()->id}}"></input>
                    <button type="submit" class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-amber-500 focus:text-gray-900 focus:outline-none md:mt-0">Movies</button>
                </form>
                @else
                <a href="/movies" class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-amber-500 focus:text-gray-900 focus:outline-none md:mt-0">Movies</a>
                @endif
                <!-- DROPDOWN BUTTON -->
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                ...
                <!--  FÖR OINLOGGADE -->
                @guest
                <a class="focus:shadow-outline mt-2 rounded-lg bg-transparent px-4 py-2 text-sm font-semibold hover:bg-amber-500 hover:text-gray-900 focus:bg-amber-500 focus:text-gray-900 focus:outline-none md:mt-0 md:ml-4" href="{{ route('login') }}">Log In</a>
                <a class="focus:shadow-outline mt-2 rounded-lg bg-transparent px-4 py-2 text-sm font-semibold hover:bg-amber-500 hover:text-gray-900 focus:bg-amber-500 focus:text-gray-900 focus:outline-none md:mt-0 md:ml-4" href="{{ route('register') }}">Sign Up</a>
                @endguest
            </nav>
            ...
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 mt-2 w-full origin-top-right rounded-md shadow-lg md:w-48 z-40">
                    <div class="rounded-md bg-black px-2 py-2 shadow">
                        <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-amber-500 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('profile.edit') }}">Settings</a>
                        <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('user_watchlist') }}">Watchlist</a>
                        <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('dashboard', Auth::user()->id) }}">Dashboard</a>
                        <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('user_lists.showAll', Auth::user()->id)}}">Lists</a>

                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('logout') }}" onclick="event.preventDefault();
            ...
            @if(Auth::user()->role == 1)
            <!-- PROFIL ADMIN LOGGED IN DROPDOWN DESKTOP -->
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 hidden lg:flex lg:flex-row lg:justify-end lg:pb-0">
                    <div class="flex flex-row">
                        <span class="sr-only">Open user menu</span>
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 mt-2 w-full origin-top-right rounded-md shadow-lg md:w-48 z-40">
                    <div class="rounded-md bg-black px-2 py-2 shadow">
                        ...
                        <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('admin_users.showAll')}}">Edit users</a>

                        <a class="focus:shadow-outline mt-2 block rounded-lg bg-transparent px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-amber-500 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0" href="{{ route('admin_movies.showAll') }}">Edit movies</a>
